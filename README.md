# Prodoc  [![GitHub version](https://badge.fury.io/gh/google%2Fmaterial-design-lite.svg)](https://badge.fury.io/gh/google%2Fmaterial-design-lite) [![npm version](https://badge.fury.io/js/material-design-lite.svg)](https://badge.fury.io/js/material-design-lite) [![Dependency Status](https://david-dm.org/google/material-design-lite.svg)](https://david-dm.org/google/material-design-lite)
...
To build the project, **these files must exist with exact filenames**:

* `public/index.html` is the page template;
* `src/index.js` is the JavaScript entry point.

Then, you will need to install all the needed packages from npm by running:

``` bash
npm install
```

You may delete or rename other files or even create subdirectories inside  `src`.
...
First at all, you should login into your Firebase account to enjoy the Hosting Service from this plataform.

``` bash
firebase login
```

To deploy the app, simply run the following command from your project directory:
